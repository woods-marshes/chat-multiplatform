package com.github.woodsmarshes.chat.components.sections
...
fun NavHeader() {
    Row(NavHeaderStyle.toModifier(), verticalAlignment = Alignment.CenterVertically) {
        Link("https://chat.iaminpain.top") {
            // Block display overrides inline display of the <img> tag, so it calculates centering better
            Image("/logo.png", "Logo", Modifier.height(2.cssRem).display(DisplayStyle.Block))
        }
